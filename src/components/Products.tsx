      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
        ...
        >
          <div>
            ...
            <h3 style={{ fontSize: 30, fontWeight: 900, letterSpacing: '-0.03em', color: '#0A0A0A', marginBottom: 10 }}>Dodo</h3>
            <p style={{ fontSize: 14, fontWeight: 600, color: '#0A0A0A', marginBottom: 10 }}>Stop forgetting the important stuff.</p>
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', paddingTop: 24, borderTop: '1px solid #EDE9FE', marginTop: 24 }}>
            <span style={{ fontSize: 13, fontWeight: 600, color: '#7C3AED' }}>Try Dodo free</span>
