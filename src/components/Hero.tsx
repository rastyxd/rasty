    ...
    <section className="relative pt-36 pb-20 px-8 text-center overflow-hidden bg-r-bg">
      ...
      >
        ...
        <div className="flex items-center justify-center gap-3 mb-16">
          ...
          <a
            href="#about"
            className="text-[14px] font-medium text-r-muted hover:text-r-text transition-colors no-underline px-4 py-3"
          >
            What is Rasty? →
          </a>
        </div>
        ...
        <div className="flex items-center justify-center gap-16 pt-8 border-t border-r-border">
          {stats.map((s) => (
            <div key={s.label} className="text-center">
              <div className="text-[34px] font-black tracking-[-0.03em] text-r-text leading-none mb-1.5">
                {s.value}
              </div>
              <div className="text-[12px] font-medium text-r-muted">
                {s.label}
              </div>
            </div>
          ))}
